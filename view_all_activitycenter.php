...
$sql9="select * from tb_news  where type_news='activitycenter' order by id_news desc  "; 
           ...
           $i++;
                  ...
                  if($i == 1){
                              ...
                              <div class='thumbnail'>
                                <div class='blockDtl'>
                                  <h4>$title_news</h4>
                                  <a href='news_activitycenter.php?id=$id_news-$title_news'><img src='images/file/otop/$img_news' alt=$title_news'></a>
