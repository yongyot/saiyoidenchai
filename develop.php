...
$sql9="select * from tb_dev  where type='dev'"; 
$result9=mysql_db_query($dbname,$sql9);
	  ...
	  while($record10=mysql_fetch_array($result9)) {
	$dev1=$record10[dev];
	$description=$record10[description];
	echo "
	<p>$description  </p>
	  <p align='left'> <img src='images/Paper-Clip-icon.png' width='35' height='35' />ไฟล์แนบ : <a href='images/file/$dev1' target='_blank'> $dev1 </a></p>
  <object data='images/file/$dev1' type='application/pdf' width='100%' height='740px' internalinstanceid='167' title='$dev1'>
                  </object>
                <br />
		   ";
  }
