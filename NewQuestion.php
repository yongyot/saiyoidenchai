...
<link rel="stylesheet" type="text/css" href="themes/textarea/src/bootstrap-wysihtml5.css"/>
	   ...
	   <h3 class="color_custom">สร้างกระทู้</h3>
       <div style="text-align:left">
		<h5>เรียนผู้ใช้กระดาน ถาม - ตอบ</h5>
<p>การให้บริการในส่วนนี้ เหมาะสำหรับเรื่องที่สามารถเปิดเผยต่อสาธารณชนได้และเพื่อให้การลงประกาศเป็นไปอย่างมีระเบียบและเป็นประโยชน์แก่ผู้ที่สนใจมากที่สุด ขอความร่วมมือผู้ที่ต้องการลงประกาศทุกท่านให้ช่วยทำตามกติกาการลงประกาศ ดังนี้ </p>

<p>1. ห้ามพาดพิงถึงสถาบัน ชาติ ศาสนา พระมหากษัตริย์ </p>
<p>2. ห้ามใช้เป็นกระดานคุยหรือโต้ตอบในเรื่องไม่สร้างสรรค์</p>
<p>3. ห้ามใช้ถ้อยคำที่ไม่สุภาพ</p>

<p>4. ห้ามโฆษณาขายของทุกชนิด </p>

<p>หมายเหตุ เจ้าหน้าที่ดูแลระบบเห็นว่าไม่เหมาะสมที่จะเปิดเผยต่อ สาธารณชน กระทู้จะถูกลบทันที</p>
</div>
...
<form action="NewQuestion.php?Action=Save" method="post" name="frmMain" id="frmMain">
   <table class="table table-striped table-bordered">
    <tr>
      ...
      <td><input name="txtQuestion" type="text"  style="width:90%" id="txtQuestion" value="" ></td>
    </tr>
    <tr>
      <td width="78">เนื้อหา 
      <span style="color:#F00">*</span>
      ...
      <td><textarea name="txtDetails" class="textarea" rows="15" style="width:90%" id="txtDetails"></textarea></td>
    </tr>
    <tr>
      <td width="78">ชื่อ
       <span style="color:#F00">*</span>
      </td>
      <td width="647"><input name="txtName" type="text"  style="width:90%" id="txtName" value="" size="50"></td>
    </tr>
       <tr>
    <td></td>
    <td>
...
<div class="form-actions">
		...
		<button type="submit" id="bnt_submit" disabled="disabled" class="btn btn-primary" name="btnSave">สร้างกระทู้</button>
