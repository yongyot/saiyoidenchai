...
'','','$fileupload_name','$fileupload2_name','$fileupload3_name','$fileupload4_name','$fileupload5_name','$fileupload6_name','$fileupload7_name','people','$date_reg')";
 ...
 <li><a href="news_otop_admin.php?mode=activitycenter"><i class="icon-cog"></i>ศูนย์บริการและถ่ายทอดเทคโนโลยีการเกษตรประจำตำบลไทรย้อย</a></li>
      ...
      <div class="span9">
		...
		<table width="95%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <th scope="col"><form id="form1" name="form1" method="post" action="news_people_admin.php" enctype="multipart/form-data">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <th align="left" valign="top" class="body1" scope="col">&nbsp;</th>
                                    <th colspan="2" align="left" valign="top" class="body2-head" scope="col">เพิ่มคู่มือประชาชน</th>
                                  </tr>
                                  <tr>
                                    <th align="left" valign="top" class="body1" scope="col">&nbsp;</th>
                                    <th align="left" valign="top" class="body1" scope="col">&nbsp;</th>
                                  ...
                                  <tr>
                                    ...
                                    <td align="left" valign="top" class="body1">&nbsp;</td>
                                    <td align="left" valign="top" class="body1">&nbsp;</td>
                                    <td align="left" valign="top" class="body1" style="color:#F00">รองรับไฟล์ .pdf เท่านั้น</td>
                                  </tr>
...
$result9=mysql_db_query($dbname,$sql9);
  ...
  <ul class='media-list'>
		  <li class='media well well-small'>
				<a class='pull-left' href='../people.php?id=$id_news-$topic'>
 ...
 echo " 		   <br><a class='pull-right' href='../people.php.php?id=$id_news-$topic'><strong>more</strong></a>
					<br>
					<a href='update_people.php?id=$id_news' onclick=\"return confirm('คุณต้องการลบข้อมูล?')\"><img src='../images/delete.jpg' border='0' /></a>
				</div>
		  </li>
