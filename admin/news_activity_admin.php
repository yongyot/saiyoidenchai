...
'','','$fileupload_name','$fileupload2_name','$fileupload3_name','$fileupload4_name','$fileupload5_name','$fileupload6_name','$fileupload7_name','activity','$date_reg')";
...
$result9=mysql_db_query($dbname,$sql9);
  ...
  <ul class='media-list'>
		  <li class='media well well-small'>
				<a class='pull-left' href='../news_activity.php?id=$id_news-$topic'>
				  <img width='135' class='media-object' src='../images/photo/$img_news' alt='$topic'>
				</a>
 ...
 echo " 		   <br><a class='pull-right' href='../news_activity.php?id=$id_news-$topic'><strong>more</strong></a>
					<br>
					<a href='update_activity.php?id=$id_news' onclick=\"return confirm('คุณต้องการลบข้อมูล?')\"><img src='../images/delete.jpg' border='0' /></a>
				</div>
		  </li>
