...
'','','$fileupload_name','$fileupload2_name','$fileupload3_name','$fileupload4_name','$fileupload5_name','$fileupload6_name','$fileupload7_name','pr','$date_reg')";
...
$result9=mysql_db_query($dbname,$sql9);
  ...
  <ul class='media-list'>
		  <li class='media well well-small'>
				<a class='pull-left' href='../news_pr.php?id=$id_news-$topic'>
 ...
 echo " 		   <br><a class='pull-right' href='../news_pr.php?id=$id_news-$topic'><strong>more</strong></a>
					<br>
					<a href='update_pr.php?id=$id_news' onclick=\"return confirm('คุณต้องการลบข้อมูล?')\"><img src='../images/delete.jpg' border='0' /></a>
				</div>
		  </li>
