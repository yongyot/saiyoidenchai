...
$result9=mysql_db_query($dbname,$sql9);                                 
  ...
  <tr>
    ...
    <th align='left' scope='col'><a href='../admin/update_youtube.php?id=$id' onclick=\"return confirm(' แน่ใจว่าต้องการลบyoutubeนี้?')\"><img src='../images/delete.jpg' border='0' /></a></th>
  </tr>
</table>   ";
	  $amount++;
			  }//end while	youtube4
...
?></th>
                          ...
                          <tr align="left" class="body1-2">
                            ...
                            <th valign="top" scope="col">เพิ่ม youtube 
                              <form id="form1" name="form1" method="post" action="youtube_admin.php" style="width:95%">
                                <p>
                                  <input name="add_youtube" type="text" value="http://www.youtube.com/embed/"  placeholder="http://www.youtube.com/embed" size="50" />
