...
<section id="bodySection" >
  <div class="container">
	...
	<form class="form-signin"  method='post' action='chkmember.php'>
        <h2 class="form-signin-heading">Please sign in</h2>
        <label for="inputEmail" class="sr-only">Email address</label>
        <input type="email" id="inputEmail" name='user_login'  class="form-control" placeholder="Email address" required="" autofocus="">
        <label for="inputPassword" class="sr-only">Password</label>
        <input type="password" name='pass_login' id="inputPassword" class="form-control" placeholder="Password" required="">
