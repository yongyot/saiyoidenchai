...
<section id="bodySection" >
 ...
 <li><a href="news_otop_admin.php?mode=activitycenter"><i class="icon-cog"></i>กิจกรรมศูนย์ฯ</a></li>
    ...
    <caption style="font:16px!important">ศูนย์รับเรื่องราวร้องทุกข์</caption>
     <thead>
      <tr> 
      <th>#</th> 
      <th>หัวข้อ</th> 
...
$i = 0;
$sql9="select * from tb_mail  where type='ร้องทุกข์' order by id_mail desc  "; 
...
$email=$record9[email];
	...
	echo"	<tr> <th scope='row'>$i</th> <td>$topic</td> <td>$detail</td> <td>$Name</td>
...
?>
 ...
 <br />
   	<table class="table table-bordered datagrid" > 
    <caption style="font:16px!important">ติดต่อเรา</caption>
     <thead>
      <tr> 
      <th>#</th> 
      <th>หัวข้อ</th> 
...
include "../themes/php/connect/connect.php";
$i = 0;
$sql9="select * from tb_mail  where type='ติดต่อ' order by id_mail desc  "; 
$result9=mysql_db_query($dbname,$sql9);
