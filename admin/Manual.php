...
<body  style="background: url(file:///D|/Project/BOY/Freelance/อบต.ย้อยไทร/Code/prototype/themes/switch/images/pattern/pattern21.png) 0px 0px / cover repeat scroll;">
<!-- InstanceBeginEditable name="header_content" -->header_content<!-- InstanceEndEditable -->
<!-- Menu --> 
