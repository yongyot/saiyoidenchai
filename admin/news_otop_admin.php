...
if($mode== "otop"){
 ...
 $pathimage = "otop/travel";
 $pathimage1 = "travel/";
}else if($mode== "tradition"){
 $pathimage = "otop/tradition";
 $pathimage1 = "tradition/";
}else if($mode=="activitycenter"){
		 $pathimage = "otop/activitycenter";
         $pathimage1 = "activitycenter/";
}
...
if ($fileupload) {
	...
	if ($lastname=="gif" or $lastname=="jpg" or $lastname=="jpeg"  or $lastname=="png" ) {
		copy($fileupload,"../images/file/$pathimage/".$fileupload_name);	
	}
	}
...
if ($fileupload2) {
	...
	if ($lastname=="pdf" or $lastname=="doc" or $lastname=="txt"  or $lastname=="xls" or $lastname=="jpg" or $lastname=="jpeg" or $lastname=="zip" or $lastname=="rar" or $lastname=="ppt") {
		copy($fileupload2,"../images/file/$pathimage/".$fileupload2_name);	
	}
	}
...
if ($fileupload3) {
	...
	$lastname=strtolower($array_last[$c]) ;
	if ($lastname=="pdf" or $lastname=="doc" or $lastname=="txt"  or $lastname=="xls" or $lastname=="jpg" or $lastname=="jpeg" or $lastname=="zip" or $lastname=="rar" or $lastname=="ppt") {
		copy($fileupload3,"../images/file/$pathimage/".$fileupload3_name);	
	}
	}
...
if ($fileupload4) {
	...
	$lastname=strtolower($array_last[$c]) ;
	if ($lastname=="pdf" or $lastname=="doc" or $lastname=="txt"  or $lastname=="xls" or $lastname=="jpg" or $lastname=="jpeg" or $lastname=="zip" or $lastname=="rar" or $lastname=="ppt") {
		copy($fileupload4,"../images/file/$pathimage/".$fileupload4_name);	
	}
	}
...
if ($fileupload5) {
	...
	$lastname=strtolower($array_last[$c]) ;
	if ($lastname=="pdf" or $lastname=="doc" or $lastname=="txt"  or $lastname=="xls" or $lastname=="jpg" or $lastname=="jpeg" or $lastname=="zip" or $lastname=="rar" or $lastname=="ppt") {
		copy($fileupload5,"../images/file/$pathimage/".$fileupload5_name);	
	}
	}
...
if ($fileupload6) {
	...
	$lastname=strtolower($array_last[$c]) ;
	if ($lastname=="pdf" or $lastname=="doc" or $lastname=="txt"  or $lastname=="xls" or $lastname=="jpg" or $lastname=="jpeg" or $lastname=="zip" or $lastname=="rar" or $lastname=="ppt") {
		copy($fileupload6,"../images/file/$pathimage/".$fileupload6_name);	
	}
	}
...
if ($fileupload7) {
	...
	$lastname=strtolower($array_last[$c]) ;
	if ($lastname=="pdf" or $lastname=="doc" or $lastname=="txt"  or $lastname=="xls" or $lastname=="jpg" or $lastname=="jpeg" or $lastname=="zip" or $lastname=="rar" or $lastname=="ppt") {
		copy($fileupload7,"../images/file/$pathimage/".$fileupload7_name);	
	}
	}
...
'','','$pathimage1$fileupload_name','$pathimage1$fileupload2_name','$$pathimage1fileupload3_name','$pathimage1$fileupload4_name','$pathimage1$fileupload5_name','$pathimage1$fileupload6_name','$pathimage1$fileupload7_name','$mode','$date_reg')";
 ...
 <li><a href="news_otop_admin.php?mode=activitycenter"><i class="icon-cog"></i>กิจกรรมศูนย์ฯ</a></li>
      ...
      <?  
	    $mode=$_GET[mode];         
             ...
             if($mode== "otop"){
echo	"<form id='form1' name='form1' method='post' action='news_otop_admin.php?mode=otop' enctype='multipart/form-data'>";
}else if($mode== "travel"){
	echo	"<form id='form1' name='form1' method='post' action='news_otop_admin.php?mode=travel' enctype='multipart/form-data'>";
}else if($mode== "tradition"){
echo	"<form id='form1' name='form1' method='post' action='news_otop_admin.php?mode=tradition' enctype='multipart/form-data'>";
	}
	else if($mode== "activitycenter"){
echo	"<form id='form1' name='form1' method='post' action='news_otop_admin.php?mode=activitycenter' enctype='multipart/form-data'>";
	}
         ...
         ?>     
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <th colspan="2" align="left" valign="top" class="body2-head" scope="col"> <?                                  
  $mode=$_GET[mode];                              
if($mode== "otop"){
echo	"เพิ่มผลิตภัณท์เด่นของตำบล";
}else if($mode== "travel"){
	echo	"เพิ่มสถานที่สำคัญ-แหล่งท่องเที่ยว";
}else if($mode== "tradition"){
echo	"เพิ่มศิลปวัฒนธรรมประเพณี";
	}
else if($mode== "activitycenter"){
echo	"กิจกรรมศูนย์ฯ";
	}	
 ...
 ?>
                    ...
                    <tr>
                      <td align="left" valign="top" class="body1">&nbsp;</td>
                      <td align="left" valign="top" class="body1">ไฟล์ภาพหน้าปกขนาด 1280X720 : </td>
...
include "../themes/php/connect/connect.php";
$mode=$_GET[mode];
$sql9="select * from tb_news  where type_news='$mode' order by id_news desc  "; 
...
$result9=mysql_db_query($dbname,$sql9);
  ...
  <ul class='media-list'>
		  <li class='media well well-small'>
				<a class='pull-left' href='../news_otop.php?id=$id_news-$topic'>
				  <img width='135' class='media-object' src='../images/file/$pathimage/$img_news' alt='$topic'>
				</a>
 ...
 echo " 		   <br><a class='pull-right' href='../news_otop.php?id=$id_news-$topic'><strong>more</strong></a>
					<br>
					<a href='update_otop.php?id=$id_news&mode=$mode' onclick=\"return confirm('คุณต้องการลบข้อมูล?')\"><img src='../images/delete.jpg' border='0' /></a>
				</div>
		  </li>
