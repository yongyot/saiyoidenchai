...
$sql9="select * from tb_news  where type_news='people' order by id_news desc"; 
$result9=mysql_db_query($dbname,$sql9);
  ...
  while($record9=mysql_fetch_array($result9)) {
	...
	$youtube1=$record9[youtube];
		...
		echo " <img src='themes\images\pdf.png'  /> <a href='people.php?id=$id_news-$title_news';>$title_news</a> <br /><br />        ";
