...
'','','$fileupload_name','$fileupload2_name','$fileupload3_name','$fileupload4_name','$fileupload5_name','$fileupload6_name','$fileupload7_name','auction')";
...
<title>ข่าวจัดซื้อจัดจ้าง - ผู้ดูแลระบบ</title>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="5">
                    <tr valign="top">
                      ...
                      <th scope="col"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <th scope="col"><img src="images/news_auction_admin.gif" width="680" height="45" /></th>
                        </tr>
                      </table>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
...
$result9=mysql_db_query($dbname,$sql9);
  ...
  while($record9=mysql_fetch_array($result9)) {
	...
	$id_news=$record9[id_news];
		...
		<table width='100%' border='0' cellspacing='0' cellpadding='0'>
  <tr>
    <th align='left' scope='col' width='80%'><img src='images/li2.png' width='17' height='17' /> <a href='news_auction.php?id=$id_news'>$title_news</a> &nbsp;</th>
    <th align='left' scope='col'><a href='update_auction.php?id=$id_news' onclick=\"return confirm(' แน่ใจว่าต้องการลบข่าวจัดซื้อจัดจ้างนี้?')\"><img src='images/delete.jpg' border='0' /></a></th>
  </tr>
</table>
		<br />        ";
                          ...
                          <tr>
                            <th scope="col"><form id="form1" name="form1" method="post" action="news_auction_admin.php" enctype="multipart/form-data">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                  <td align="left" valign="top" class="body1">&nbsp;</td>
                                  <td align="left" valign="top" class="body1">แนบไฟล์ : </td>
