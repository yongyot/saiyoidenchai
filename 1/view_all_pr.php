                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="5">
                    <tr valign="top">
                      ...
                      <th scope="col"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <th scope="col"><img src="images/news_pr.gif" width="680" height="45" /></th>
                        </tr>
                      </table>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
...
$result9=mysql_db_query($dbname,$sql9);
  ...
  while($record9=mysql_fetch_array($result9)) {
	...
	$youtube1=$record9[youtube];
		...
		echo " <img src='images/li2.png' width='17' height='17' /> <a href='news_pr.php?id=$id_news';>$title_news</a> <br /><br />        ";
