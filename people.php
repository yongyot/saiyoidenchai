 ...
 while($record9=mysql_fetch_array($result9)) {
  ...
  ";
	...
	";
		...
		if($img_news!=''){ echo"		  <p align='left'> <img src='images/Paper-Clip-icon.png' width='35' height='35' />ไฟล์แนบ : <a href='images/file/$img_news' target='_blank'> $img_news </a></p>
  <object data='images/file/$img_news' type='application/pdf' width='100%' height='740px' internalinstanceid='167' title='$img_news'>
                  </object>
                <br />           <br />
				       ";}
					   if($img_news2!=''){ echo"		  <p align='left'> <img src='images/Paper-Clip-icon.png' width='35' height='35' />ไฟล์แนบ : <a href='images/file/$img_news2' target='_blank'> $img_news2 </a></p>
  <object data='images/file/$img_news2' type='application/pdf' width='100%' height='740px' internalinstanceid='167' title='$img_news2'>
                  </object>
                <br />           <br />
				       ";}
					   if($img_news3!=''){ echo"		  <p align='left'> <img src='images/Paper-Clip-icon.png' width='35' height='35' />ไฟล์แนบ : <a href='images/file/$img_news3' target='_blank'> $img_news3 </a></p>
  <object data='images/file/$img_news3' type='application/pdf' width='100%' height='740px' internalinstanceid='167' title='$img_news3'>
                  </object>
                  <br />           <br />
				       ";}
					   if($img_news4!=''){ echo"		  <p align='left'> <img src='images/Paper-Clip-icon.png' width='35' height='35' />ไฟล์แนบ : <a href='images/file/$img_news4' target='_blank'> $img_news4 </a></p>
  <object data='images/file/$img_news4' type='application/pdf' width='100%' height='740px' internalinstanceid='167' title='$img_news4'>
                  </object>
                 <br />           <br />
				       ";}
					   if($img_news5!=''){ echo"	  <p align='left'> <img src='images/Paper-Clip-icon.png' width='35' height='35' />ไฟล์แนบ : <a href='images/file/$img_news5' target='_blank'> $img_news5 </a></p>
  <object data='images/file/$img_news5' type='application/pdf' width='100%' height='740px' internalinstanceid='167' title='$img_news5'>
                  </object>
              <br />           <br />
				       ";}
					   if($img_news6!=''){ echo"		  <p align='left'> <img src='images/Paper-Clip-icon.png' width='35' height='35' />ไฟล์แนบ : <a href='images/file/$img_news6' target='_blank'> $img_news6 </a></p>
  <object data='images/file/$img_news6' type='application/pdf' width='100%' height='740px' internalinstanceid='167' title='$img_news6'>
                  </object>
                <br />           <br />
				       ";}
					   if($img_news7!=''){ echo"		  <p align='left'> <img src='images/Paper-Clip-icon.png' width='35' height='35' />ไฟล์แนบ : <a href='images/file/$img_news7' target='_blank'> $img_news7 </a></p>
  <object data='images/file/$img_news7' type='application/pdf' width='100%' height='740px' internalinstanceid='167' title='$img_news7'>
                  </object>
                  <br />           <br />
				       ";}	   
