    ...
    margin-top: 20px;" >
      ...
      <div class="span9"> <!-- InstanceBeginEditable name="Content" -->
	    ...
	    <div class="well well-small  page_statice" style="text-align:left">
          <h3></h3>
          <ul class="media-list Detail_All" style="padding-top:30px">
            <li class="media well well-small">
              <div class="media-body" >
                <div class="row-fluid">
                  <div class="span12" style="margin-left: 0px!important;">
                    <div class="tabbable tabs">
                      <div class="tab-content label-primary" style="overflow:hidden">
                        <div class="tab-pane active" id="all">
                     
                        <h3 style="color: #FE5214;">ผลิตภัณฑ์เด่นของตำบล</h3>
...
$sql9="select * from tb_news  where type_news='otop' order by id_news desc  "; 
$result9=mysql_db_query($dbname,$sql9);
$num_rows = mysql_num_rows($result9);
    ...
    $description_news=$record9[description_news];
           ...
           $i++;
                  ...
                  if($i == 1){
					          ...
					          echo "      <li class='span4 br'>
                              <div class='thumbnail'>
                                <div class='blockDtl'>
                                  <h4>$title_news</h4>
                                  <a href='news_otop.php?id=$id_news-$title_news'><img src='images/file/otop/$img_news' alt=$title_news'></a>
...
?>
                          ...
                          <hr class="soften" >
                          <h3 style="color: #FE5214;text-align:left">สถานที่สำคัญ - เเหล่งท่องเที่ยว</h3>
...
$sql9="select * from tb_news  where type_news='travel' order by id_news desc  "; 
$result9=mysql_db_query($dbname,$sql9);
$num_rows = mysql_num_rows($result9);
...
?>
                            ...
                            <hr class="soften" >
                          <h3 style="color: #FE5214;text-align:left">ศิลปวัฒนธรรมประเพณี</h3>
...
$sql9="select * from tb_news  where type_news='tradition' order by id_news desc  "; 
$result9=mysql_db_query($dbname,$sql9);
$num_rows = mysql_num_rows($result9);
