...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en"><!-- InstanceBegin template="/Templates/custom_content_statice.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
...
<section id="bodySection" >
  <div class="container">
    ...
    margin-top: 20px;" >
      ...
      <h3></h3>
      <ul class="media-list" style="padding-top:30px">
...
list($titleid, $titilename) = split('[-]', $id);
$sql9="select * from tb_news  where  id_news='$titleid' "; 
$result9=mysql_db_query($dbname,$sql9);

                                  
  while($record9=mysql_fetch_array($result9)) {
	$title_news=$record9[title_news];
	$description_news=$record9[description2_news];
	...
	$img_news7=$record9[img_news7];
     	$date_created1=date_create($record9[date_created]);
    $date_created = date_format($date_created1, 'd/m/Y');
  echo "
     <div style='text-align:left'>
              <h3 style='color: #FE5214'>$title_news</h3>
              </div>
  ";
  echo"
  <div>
  ...
  ";
   ...
   if($img_news!=''){
	   echo "
	     <article class='col-xs-12 col-sm-6 col-md-3'>
                      <div class='panel panel-default'>
                        <div class='panel-body'> <a href='images/file/otop/$img_news' title='$title_news' class='zoom' data-title='$title_news'  data-toggle='lightbox' data-gallery='mixedgallery' data-footer='$title_news' data-type='image' data-toggle='lightbox' data-lightbox='$title_news'> <img src='images/file/otop/$img_news' alt='$title_news' class='img-responsive' /> </a> </div>
                      </div>
                    </article>
		";
	   ...
	   echo "
	     <article class='col-xs-12 col-sm-6 col-md-3'>
                      <div class='panel panel-default'>
                        <div class='panel-body'> <a href='images/file/otop/$img_news2' title='$title_news' class='zoom' data-title='$title_news'  data-toggle='lightbox' data-gallery='mixedgallery' data-footer='$title_news' data-type='image' data-toggle='lightbox' data-lightbox='$title_news'> <img src='images/file/otop/$img_news2' alt='$title_news' class='img-responsive' /> </a> </div>
                      </div>
                    </article>
		";
	   ...
	   echo "
	     <article class='col-xs-12 col-sm-6 col-md-3'>
                      <div class='panel panel-default'>
                        <div class='panel-body'> <a href='images/file/otop/$img_news3' title='$title_news' class='zoom' data-title='$title_news'  data-toggle='lightbox' data-gallery='mixedgallery' data-footer='$title_news' data-type='image' data-toggle='lightbox' data-lightbox='$title_news'> <img src='images/file/otop/$img_news3' alt='$title_news' class='img-responsive' /> </a> </div>
                      </div>
                    </article>
		";
	   ...
	   echo "
	     <article class='col-xs-12 col-sm-6 col-md-3'>
                      <div class='panel panel-default'>
                        <div class='panel-body'> <a href='images/file/otop/$img_news4' title='$title_news' class='zoom' data-title='$title_news'  data-toggle='lightbox' data-gallery='mixedgallery' data-footer='$title_news' data-type='image' data-toggle='lightbox' data-lightbox='$title_news'> <img src='images/file/otop/$img_news4' alt='$title_news' class='img-responsive' /> </a> </div>
                      </div>
                    </article>
		";
	   ...
	   echo "
	     <article class='col-xs-12 col-sm-6 col-md-3'>
                      <div class='panel panel-default'>
                        <div class='panel-body'> <a href='images/file/otop/$img_news5' title='$title_news' class='zoom' data-title='$title_news'  data-toggle='lightbox' data-gallery='mixedgallery' data-footer='$title_news' data-type='image' data-toggle='lightbox' data-lightbox='$title_news'> <img src='images/file/otop/$img_news5' alt='$title_news' class='img-responsive' /> </a> </div>
                      </div>
                    </article>
		";
	   ...
	   echo "
	     <article class='col-xs-12 col-sm-6 col-md-3'>
                      <div class='panel panel-default'>
                        <div class='panel-body'> <a href='images/file/otop/$img_news6' title='$title_news' class='zoom' data-title='$title_news'  data-toggle='lightbox' data-gallery='mixedgallery' data-footer='$title_news' data-type='image' data-toggle='lightbox' data-lightbox='$title_news'> <img src='images/file/otop/$img_news6' alt='$title_news' class='img-responsive' /> </a> </div>
                      </div>
                    </article>
		";
	   ...
	   echo "
	     <article class='col-xs-12 col-sm-6 col-md-3'>
                      <div class='panel panel-default'>
                        <div class='panel-body'> <a href='images/file/otop/$img_news7' title='$title_news' class='zoom' data-title='$title_news'  data-toggle='lightbox' data-gallery='mixedgallery' data-footer='$title_news' data-type='image' data-toggle='lightbox' data-lightbox='$title_news'> <img src='images/file/otop/$img_news7' alt='$title_news' class='img-responsive' /> </a> </div>
                      </div>
                    </article>
		";
	    echo "<p style='text-align: right'> $date_created </p>";		  
	 }
			  }//end while											
?>
          </div>
