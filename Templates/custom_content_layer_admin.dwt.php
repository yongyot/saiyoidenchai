...
<!-- TemplateBeginEditable name="header_content" -->header_content<!-- TemplateEndEditable -->
<!-- Menu --> 
          ...
          <div class="well" style="padding: 8px 0;">
			<ul class="nav nav-list">
               ...
               <li class="nav-header">จัดการ</li>
                 ...
                 <li><a href="../admin/index.php"><i class="icon-cog"></i> หน้าแรก</a></li>
               ...
               <li><a href="../admin/news_pr_admin.php"><i class="icon-cog"></i> ข่าวประชาสัมพันธ์</a></li>
                <li><a href="../admin/news_auction_admin.php"><i class="icon-cog"></i> ข่าวจัดซื้อจัดจ้าง</a></li>
                 ...
                 <li><a href="../admin/news_fund_admin.php"><i class="icon-cog"></i> กองทุนหลักประกันสุขภาพ</a></li>
                   ...
                   <li><a href="../admin/news_people_admin.php"><i class="icon-cog"></i>คู่มือประชาชน</a></li>
...
<script src="../themes/js/business_ltd_1.0.js"></script><!-- TemplateBeginEditable name="javacript" --><!-- TemplateEndEditable -->
