...
<section id="bodySection" >
  <div class="container">
    ...
    <h3 class="color_custom">กระดานสนทนา ถาม - ตอบ อบต.ไทรย้อย</h3>
    
    
      <link rel="stylesheet" type="text/css" href="themes/css/table.css"/>
     <div  style="text-align:left"> <a href="NewQuestion.php"> <button class="btn btn-success">สร้างกระทู้</button></a>  อบต.ไทรย้อย อยากให้สมาชิกของเราได้โพสความคิดเห็น ข้อเสนอแนะ เรื่องราวเกี่ยวกับ ปัญหา ความเดือดร้อนของท่าน ลงไปในบอร์ดนี้ เพื่อเราได้นำข้อมูลเหล่นนั้น นำเสนอแก่ผู้บริหารให้ได้รับทราบ และยังจะได้ใช้เป็นแนวทางในการวางแผนการจัดการพัฒนาท้องถิ่นต่อไปด้วย </div>
      <?
...
?>
      <div style="overflow:auto"  class="datagrid">
        <table  style="width:100%" >
          <thead>
            <tr>
              <th width="99px"> <div align="center"></div></th>
              <th> <div align="center">หัวข้อกระทู้</div></th>
              <th width="90px"> <div align="center">ผู้ตั้งกระทู้</div></th>
              <th width="130px"> <div align="center">วันที่ตั้ง</div></th>
              <th width="45px"> <div align="center">อ่าน</div></th>
              <th width="47px"> <div align="center">ตอบ</div></th>
            </tr>
          </thead>
          <tbody>
            <?
